    ...
    () => {
      ...
      mm.add(
        ...
        (context) => {
          ...
          const heroItems = gsap.utils.toArray<HTMLElement>('[data-hero-reveal]', scopeElement);

          gsap.fromTo(
            heroItems,
            reduceMotion ? { autoAlpha: 0 } : { autoAlpha: 0, y: 20 },
            {
              autoAlpha: 1,
              y: 0,
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10 relative">
          <div className="text-center md:text-left relative">
            <div data-hero-reveal className="mb-4">
            ...
            >
              <button
                data-gsap-hover="1.04"
                data-gsap-press="0.97"
